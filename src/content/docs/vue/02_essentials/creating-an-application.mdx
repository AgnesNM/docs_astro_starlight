---
title: CreatingAnApplication
description: Learn about CreatingAnApplication in Vue.js
---
...
The content of the app's root component will be rendered inside the container. The container element itself is not considered part of the app.
...
This makes the `TodoDeleteButton` available for use anywhere in our app. We will discuss registration for components and other types of assets in later sections of the guide. You can also browse the full list of application instance APIs in its [API reference](https://link-to-api-reference).
