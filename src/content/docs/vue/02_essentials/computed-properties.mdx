...
description: Learn about ComputedProperties in Vue.js
---

import { Aside } from '@astrojs/starlight/components';

<Aside type="note" title="Learn">
...
At this point, the template is getting a bit cluttered. Furthermore, we probably don't want to repeat ourselves if we need to include this calculation in the template more than once.
...
See also: [Typing Computed](https://vuejs.org/guide/typescript/options-api.html#typing-computed-properties)
