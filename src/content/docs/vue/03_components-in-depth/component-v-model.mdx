---
title: ComponentVModel
description: Learn about ComponentVModel in Vue.js
---
...
The value returned by `defineModel()` is a ref. It can be accessed and mutated like any other ref.
...
Let's create a custom modifier, `capitalize`, that capitalizes the first letter of the string provided by the `v-model` binding:
